...
import top.notcoral.velocity.bandwidth.BvBandwidthContext.OutboundSample;
...
public final class MinecraftBandwidthOutboundHandler extends ChannelOutboundHandlerAdapter {
  ...
  public void write(ChannelHandlerContext ctx, Object msg, ChannelPromise promise) throws Exception {
    ...
    final OutboundSample previous = ctx.channel()
        .attr(BvBandwidthContext.OUTBOUND_SAMPLE)
    ...
    try {
      ...
      ctx.channel().attr(BvBandwidthContext.OUTBOUND_SAMPLE).set(previous);
    }
  }
